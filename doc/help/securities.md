...
The Securities page lists your **investments** — commodities you hold in positions with a cost basis (open lots), such as stocks and funds. Currencies like `EUR` and `USD` are excluded, since they are not held at a cost.

Tap a security to open its [Commodity Detail](/help/commodity-detail) page.
...
By default only open investments are listed. Enable **Show Closed** from the toolbar menu to also list securities that have been fully sold. Closed rows are tagged `Closed` and show the **realized** gain/loss from the positions you held.
