...
Reports provides quick access to a set of built-in reports:

- **Queries** — run raw BQL queries against your ledger.
- **Transaction Search** — search and filter transactions by account, payee, date range, and more.
