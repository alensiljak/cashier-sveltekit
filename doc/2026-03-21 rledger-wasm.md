...
- [ ] Add 'validate' section with a button for manuall validation and display for validation result.
- [ ] Ensure that WASM functions can be called. It seems that only JS Fallback is executed every time.
